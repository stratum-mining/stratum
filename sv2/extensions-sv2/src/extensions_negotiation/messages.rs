...
impl fmt::Display for RequestExtensions<'_> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        let extensions_list = format!("{}", self.requested_extensions);
        write!(
            f,
...
impl fmt::Display for RequestExtensionsSuccess<'_> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        // Clone to get the inner vec for display
        let extensions_list = format!("{}", self.supported_extensions);
        write!(
            f,
...
impl fmt::Display for RequestExtensionsError<'_> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        let unsupported_list = format!("{}", self.unsupported_extensions);
        let required_list = format!("{}", self.required_extensions);
        write!(
            f,
