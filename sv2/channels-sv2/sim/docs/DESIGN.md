...
Empirical results are in [`FINDINGS.md`](./FINDINGS.md) (mechanistic
narrative) and [`pareto.md`](../pareto.md) (full side-by-side
cross-algorithm comparison auto-generated by
