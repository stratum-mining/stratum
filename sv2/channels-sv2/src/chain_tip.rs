...
impl ChainTip {
    ...
    pub fn new(prev_hash: U256, nbits: u32, min_ntime: u32) -> Self {
        Self {
            prev_hash,
            nbits,
            min_ntime,
...
impl From<SetNewPrevHashTdp> for ChainTip {
...
impl From<SetNewPrevHashMp> for ChainTip {
