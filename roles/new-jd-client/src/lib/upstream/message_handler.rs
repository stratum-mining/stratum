use stratum_common::roles_logic_sv2::{
    codec_sv2::binary_sv2::{u256_from_int, Str0255, U256}, common_messages_sv2::{
        ChannelEndpointChanged, Protocol, Reconnect, SetupConnection, SetupConnectionError,
        SetupConnectionSuccess,
    }, handlers_sv2::{HandleCommonMessagesFromServerAsync, HandlerError as Error}, mining_sv2::OpenExtendedMiningChannel, parsers_sv2::{AnyMessage, Mining}
};
use tracing::info;
...
impl HandleCommonMessagesFromServerAsync for Upstream {
    async fn handle_setup_connection_success(
        ...
        let open_extended_mining_channel = AnyMessage::Mining(Mining::OpenExtendedMiningChannel(OpenExtendedMiningChannel {
            request_id: 1,
            user_identity,
