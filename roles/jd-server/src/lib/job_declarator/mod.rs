...
use crate::{jds_config, mempool::JDsMempool, status, EitherFrame, JdsConfig, JdsError, StdFrame};
...
impl JobDeclaratorDownstream {
    pub fn new(
        ...
        jds_config::get_coinbase_output(config).expect("Invalid coinbase output in config")[0]
