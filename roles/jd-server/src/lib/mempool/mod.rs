...
use crate::lib::mempool::hex_iterator::HexIterator;
...
impl JDsMempool {
    ...
    // 6. add a method in mempool in which are removed the transactions in a found block
    //
