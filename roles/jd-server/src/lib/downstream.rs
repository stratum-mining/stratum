use super::{
    error::JdsError,
    job_declarator::{AddTrasactionsToMempool, AddTrasactionsToMempoolInner, TransactionState},
    mempool::JDsMempool,
...
pub struct JobDeclaratorDownstream {
    ...
    pub token_to_job_map: HashMap<u32, Option<u8>, BuildNoHashHasher<u32>>,
    pub tokens: Id,
    pub public_key: Secp256k1PublicKey,
    pub private_key: Secp256k1SecretKey,
    pub mempool: Arc<Mutex<JDsMempool>>,
    // Vec<u16> is the vector of missing transactions
    pub declared_mining_job: (
        Option<DeclareMiningJob<'static>>,
        Vec<TransactionState>,
        Vec<u16>,
    ),
    pub tx_hash_list_hash: Option<U256<'static>>,
    pub add_txs_to_mempool: AddTrasactionsToMempool,
}
