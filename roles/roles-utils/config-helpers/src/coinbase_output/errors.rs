...
impl fmt::Display for Error {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        match self {
            ...
            AddrDescriptorNChildren(n) => write!(f, "Found addr() descriptor with {} children; must be exactly one valid address", n),
            ...
            RawDescriptorNChildren(n) => write!(f, "Found raw() descriptor with {} children; must be exactly one hex-encoded script", n),
