use crate::PoolError;
use roles_logic_sv2::{parsers::Mining, Error as RolesLogicSv2Error};
...
async fn send_status(
    ...
    match sender {
        ...
        Sender::DownstreamListener(tx) => match e {
            PoolError::RolesLogicSv2(RolesLogicSv2Error::NoDownstreamsConnected) => {
                tx.send(Status {
