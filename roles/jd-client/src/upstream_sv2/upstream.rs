...
impl Upstream {
    ...
    pub async fn set_custom_jobs(
        ...
        let to_send = SetCustomMiningJob {
            ...
            coinbase_tx_version: commit_mining_job.coninbase_tx_version,
            coinbase_prefix: commit_mining_job.coninbase_prefix,
            coinbase_tx_input_n_sequence: commit_mining_job.coninbase_tx_input_nsequence,
            coinbase_tx_value_remaining: commit_mining_job.coninbase_tx_value_remaining,
