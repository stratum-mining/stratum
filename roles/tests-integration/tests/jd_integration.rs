...
//
// It verifies the above by shutding down a jd-client connected to a jd-server and then starting a
// new jd-client that connects to the same jd-server successfully.
#[tokio::test]
