...
`stratum-apps` consolidates all the role utilities into a single, well-organized crate with modules instead of separate crates. This approach provides:

- **Better dependency management** - No duplicate dependencies
- **Faster compilation** - Single crate compilation unit
- **Easier maintenance** - All utilities in one place
- **Cleaner imports** - Everything available through one crate
