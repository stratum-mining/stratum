...
use stratum_core::{
    binary_sv2::Error as BinarySv2Error,
    ...
    parsers_sv2::AnyMessage as AllMessages,
};
...
pub enum Error {
    ...
    ParserError(stratum_core::parsers_sv2::ParserError),
}
...
impl From<stratum_core::parsers_sv2::ParserError> for Error {
    fn from(v: stratum_core::parsers_sv2::ParserError) -> Error {
        Error::ParserError(v)
    }
}
