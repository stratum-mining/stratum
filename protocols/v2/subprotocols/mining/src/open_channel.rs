...
/// Used by a downstream to request opening a Standard Channel.
///
/// Upon receiving [`OpenStandardMiningChannelSuccess`] message, the downstream should open
/// channel(s) on the connection within a reasonable period, otherwise the upstream should close
...
/// Used by a downstream to request opening an Extended Channel with an upstream role.
///
...
/// Used by upstream to accept [`OpenExtendedMiningChannel` request from downstream.
